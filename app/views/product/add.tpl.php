<div class="container my-4">
    ...
    <form action="" method="POST" class="mt-5">
        ...
        <div class="mb-3">
            ...
            <input name="description" type="text" class="form-control" id="description" placeholder="Description" aria-describedby="descriptionHelpBlock">
        ...
        <div class="mb-3">
            ...
            <input name="price" type="text" inputmode="numeric" class="form-control" id="price" placeholder="Prix du produit">
        </div>
